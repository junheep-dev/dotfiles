...
**On every message I write in English, first answer my actual request as usual, then append a short `📝 English` feedback block at the end.** Separate the feedback from the answer with a blank line (and a `---` divider) so it's easy to spot.
